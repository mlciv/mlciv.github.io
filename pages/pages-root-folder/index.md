...
My research centers on *Natural Language Processing*, with a specific focus on *Dialogue*. I investigate language through a range of approaches, including *Formal Symbolic Representation*, *Deep Learning*, *Structured Prediction*, and *Large Language Models*. As AI problems become increasingly complex and larger, I am specially interested in modularized AI system design, aiming for future massive collaborative AI Engineering. I have a deep interest in discrete structures, extending both within and beyond the realm of language. Furthermore, I am dedicated to addressing challenges associated with the real-world application of trustworthy AI in Education and Health. 
