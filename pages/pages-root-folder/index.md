...
# Research Interests
My research centers around on *Natural Language Processing*. I study *Multi-party/Multi-modal Dialogue* with methods covering Deep Learning, Structured Prediction, Large Language Models, etc. I am broadly obsessed with discrete structured modeling in and beyond language. I also am interested in addressing the challenges on robustness and control in practical conversational systems~(e.g., Education, Health):
...
- **Modularized NLP.** To connect each module~(e.g., LLMs) and make a coherent
          ...
          *controllable generation* with augmented-memory, symbolic,
          ...
          [BEA'23](https://aclanthology.org/2023.bea-1.47/)), and LLM fine-tuning([L@S'24](https://dl.acm.org/doi/10.1145/3657604.366466://dl.acm.org/doi/10.1145/3657604.3664664)), adapters and editing, etcs.
