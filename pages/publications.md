...
- **Controllable Learning.** I investigated *foundational models that integrating data-driven with various inductive biases*, which are critical for creating efficient and trustworthy AI systems~(especially for Education and Health). I studied graph-based parsing via latent anchoring analysis([CoNLL'19](https://aclanthology.org/K19-2013)),
      ...
      learning and supplementary pretraining ([NAACL'21](https://aclanthology.org/2021.naacl-main.62/),[COLING'25](https://arxiv.org/abs/2412.13395)), and LLM prompting and finetuning ([L@S'24](https://dl.acm.org/doi/10.1145/3657604.366466://dl.acm.org/doi/10.1145/36576043664664)), etc. 
- **Robust Deployment.** I studied language modeling under the complex environment of the real world, such as network pruning([TVCG](https://ieeexplore.ieee.org/document/10787269)), distribution shift([ACL'23](https://aclanthology.org/2023.acl-short.156)), unnoticed non-verbal behavior ([AIAIC'23](https://aichildinteraction.github.io/preprint/AIAIC23_paper_7399.pdf)), noisy speech in small-group classroom ([UMAP'23](https://dl.acm.org/doi/10.1145/3565472.3595606)),
